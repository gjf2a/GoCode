...
public class FuzzyFlagFactory {
    ...
    public void processNextRow() throws ItemNotFoundException {
    ...
    FuzzyFlag builder(FuzzyFlagRow row) throws ItemNotFoundException {
        switch (row.type) {
            ...
            default: throw new ItemNotFoundException("Can't handle fuzzy type " + row.type);
        }
    }
}
